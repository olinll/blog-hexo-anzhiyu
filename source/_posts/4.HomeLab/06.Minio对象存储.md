...
title: 自建Minio对象存储
aliases:
date: 2025-12-27T15:59
updated: 2025-12-27T16:00
categories:
  - HomeLab
tags:
  - 软件分享
cover: assets/06.Minio对象存储/cover.png
published: true
---
![](assets/06.Minio对象存储/file-20251227160007314.png)Minio 是一个基于Apache License v2.0开源协议的对象存储服务，虽然轻量，却拥有着不错的性能。它兼容亚马逊S3云存储服务接口，非常适合于存储大容量非结构化的数据。
